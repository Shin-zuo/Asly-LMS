...
/* Ensure it stays visible on large screens */
...
<body>
    ...
    <!-- Hamburger Button -->
    <button class="btn btn-outline-secondary me-2 d-inline-flex d-lg-none align-items-center justify-content-center" 
            type="button" 
            id="sidebarToggle"
