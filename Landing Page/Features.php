    ...
    <div class="container my-5 pt-5">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="container my-5">
                    <div class="row justify-content-center">
                        <div class="col-12 d-flex justify-content-center">
                            <div
                                style="width:900px; height:400px; overflow:hidden; border-radius:20px; box-shadow:0 4px 24px rgba(0,0,0,0.08); background:#fffef1; display:flex; align-items:center; justify-content:center;">
                                <img src="../images/image3.jpg" alt="Central Sterile Services Banner"
                ...
                <!-- Post Content -->
                <p><strong>Computer System Servicing NC II (CSS NC II)</strong> is a TESDA-accredited
                    technical-vocational course that trains students to install, configure, maintain, and repair
                    computer systems and networks...</p>

                <h2 id="Skills">Skills You'll Gain</h2>
                <ul style="color: #959094;">
                    <li><strong>Computer Hardware Servicing</strong> – Assembling, disassembling, and troubleshooting
                        computer components.</li>
                    <li><strong>Networking</strong> – Installing, configuring, and maintaining computer networks
                        (LAN/WAN).</li>
                    <li><strong>Software Installation and Configuration</strong> – Installing operating systems,
                        applications, and security software.</li>
                    <li><strong>System Maintenance</strong> – Performing preventive and corrective maintenance of
                        computers and peripherals.</li>
                    <li><strong>Technical Support</strong> – Providing customer service and technical assistance for
                        ICT-related issues.</li>
                </ul>
                ...
                <p>Upon completing the program, learners will have the opportunity to take the <strong>national
                        assessment</strong> conducted by <strong>TESDA</strong>...</p>

                <h2 id="WhyEnroll">Why Enroll in This Program?</h2>
                <p>The <strong>Computer Systems Servicing NC II (CSS NC II)</strong> program is an excellent choice for
                    students...</p>
            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="sterile1.php" class="text-decoration-none">Central Sterile Processing
                                        Technology</a></li>
                                <li><a href="sterile2.php" class="text-decoration-none">Central Sterile Services</a></li>
                                <li>
                                    <a href="computer-systems.php"
                                        class="text-decoration-none active-course">Computer Systems Servicing NC II</a>
                                    <ul class="list-unstyled ms-3">
                                        <li><a href="#Skills"
                                                style="color:#959094; text-decoration:none;">Skills You'll Gain</a></li>
                                        <li><a href="#Career"
                                                style="color:#959094; text-decoration:none;">Career path and
                                                Opportunities</a></li>
                                        <li><a href="#Certification"
                                                style="color:#959094; text-decoration:none;">Certification and
                                                Achievements</a></li>
                                        <li><a href="#WhyEnroll"
                                                style="color:#959094; text-decoration:none;">Why Enroll in this
                                                Program?</a></li>
                                    </ul>
                                </li>
                                <li><a href="web-development.php" class="text-decoration-none">Web Development NC
                                        III</a></li>
                                <li><a href="java-programming.php" class="text-decoration-none">Java Programming NC
                                        III</a></li>
                            </ul>
                        </div>
                    </div>
