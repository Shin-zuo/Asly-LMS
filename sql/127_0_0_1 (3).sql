...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 25, 2025 at 05:44 AM
...
--
CREATE DATABASE IF NOT EXISTS `aiciwrxe_asly_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `aiciwrxe_asly_db`;
...
CREATE TABLE IF NOT EXISTS `educationlevel` (
  `id` int NOT NULL,
  `educationLevel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `enrollees` (
  ...
  `lastSchoolAttended` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `lastSchoolYr` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `birthDate` date NOT NULL,
  `gender` enum('Male','Female','Other') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `dateEnrolled` date NOT NULL,
  `courseId` int NOT NULL,
  `educationalAttainment` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
