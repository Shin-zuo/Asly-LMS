...
<div class="tab-pane fade" id="SHSStrand">
    <div class="container mt-4 p-5 rounded position-relative" style="border-radius: 15px; overflow: hidden;">
        ...
        <div style="
            ...
            filter: hue-rotate(200deg) saturate(200%) brightness(90%);
            position: absolute;
        ...
        <div style="position: relative; z-index: 1;">
            <h2 style="color: #f9a825;">Our Core Values</h2>
            <p class="lead">At AITCI, our core values guide everything we do—from how we teach, how we learn, and how we grow together. These values form the foundation of our culture and represent what we stand for as an institution.</p>

            <div class="row g-4 mt-3">
                <!-- A - Aspire -->
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-3 border-0 shadow-sm bg-transparent">
                        <h5 class="card-title">A - Aspire</h5>
                ...
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-3 border-0 shadow-sm bg-transparent">
                        <h5 class="card-title">I - Integrity</h5>
                ...
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-3 border-0 shadow-sm bg-transparent">
                        <h5 class="card-title">T - Technology Integration</h5>
                ...
                <div class="col-12 col-md-6">
                    <div class="card h-100 p-3 border-0 shadow-sm bg-transparent">
                        <h5 class="card-title">C - Competent</h5>
                ...
                <div class="col-12">
                    <div class="card h-100 p-3 border-0 shadow-sm bg-transparent">
                        <h5 class="card-title">I - Innovation</h5>
